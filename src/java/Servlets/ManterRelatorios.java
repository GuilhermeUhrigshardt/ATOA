 ...
 * @author guilh
 */
@WebServlet(name = "ManterRelatorios", urlPatterns = {"/ManterRelatorios"})
public class ManterRelatorios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Response resp = client.target("http://localhost:21836/RHINDO/webresources/funcionarios/departamento/" + funcionario.getDepartamento().getIdDepartamento()).request(MediaType.APPLICATION_JSON).get();
