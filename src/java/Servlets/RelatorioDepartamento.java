    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Connection con = null;
            try {
                ...
                con = DriverManager.getConnection("jdbc:mysql://localhost/atoa", "root", "1q2w3e4r5");
                ...
                departamento = client.target("http://localhost:21836/RHINDO/webresources/funcionarios/departamento/nome/" + idD).request(MediaType.APPLICATION_JSON).get(Departamento.class);
