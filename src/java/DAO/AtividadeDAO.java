...
public class AtividadeDAO {
    ...
    ResultSet rs = null;
    private String cadastrarAtividade = "insert into Atividade (idEstado, idTipoAtividade, idFuncionario, idDepartamento, inicio, fim, descricao) values (1, ?, ?, ?, curdate(), null, ?)";
